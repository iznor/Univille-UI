...
class PlayerRouter {
  ...
  private setup() {
    ...
    this.router.get('/leaderboard/:limit', playerController.getLeaderboardPlayers);
    this.router.get('/achieve/:identity/:gameCode/:missionId/:missionDuration', playerController.setAchievement);
